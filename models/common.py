...
class DecoupledHead(nn.Module):
    def __init__(self, ch=256, nc=80, anchors=()):
        ...
        self.obj_conv1 = DWConv(self.o, self.o, 3, 1, 1)
        ...
        self.obj_conv2 = DWConv(self.o, self.o, 3, 1, 1)
        
        self.cls_preds = nn.Conv2d(self.o, (self.nc) * self.na, 1)
        self.clr_preds = nn.Conv2d(self.o, (3) * self.na, 1)
        self.reg_preds = nn.Conv2d(self.o, (8) * self.na, 1)
        self.obj_preds = nn.Conv2d(self.o, (1) * self.na, 1)
    ...
    def forward(self, x):
        ...
        x1 = self.cls_conv2(x1) +x
        x2 = self.clr_conv2(x2) +x
        x3 = self.reg_conv2(x3) +x
        x4 = self.obj_conv2(x4) +x
       
        x1 = self.cls_preds(x1)
        x2 = self.clr_preds(x2)
        x3 = self.reg_preds(x3)
        x4 = self.obj_preds(x4)
      
        out = torch.cat([x3,x4,x2,x1], 1)
        return out